...
public class OTPManager : MonoBehaviour
{
    ...
    IEnumerator LoadUserAndProceed()
    {
        ...
        yield return StartCoroutine(FirestoreManager.Instance.LoadUser(
            ...
            (user) =>
            {
                ...
                PlayerVoiceResolver.SaveGender(user.gender);
    ...
    IEnumerator SaveUserAndProceed()
    {
        ...
        string normalizedGender = PlayerVoiceResolver.NormalizeGender(gender);
        string aiCompanion = normalizedGender == "female"
            ? "girl_comp"
            : "boy_comp";

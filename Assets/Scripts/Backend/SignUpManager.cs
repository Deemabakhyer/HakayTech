    ...
    IEnumerator SignUpFlow()
    {
        ...
        yield return StartCoroutine(FirebaseManager.Instance.SendOTP(
            ...
            (response) => {
                ...
                string selectedGender = sexDropdown.options[sexDropdown.value].text;
                PlayerPrefs.SetString("pendingGender", selectedGender);
                PlayerVoiceResolver.SaveGender(selectedGender);

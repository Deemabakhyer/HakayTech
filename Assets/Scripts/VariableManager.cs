    ...
    public void SaveVariable()
    {
        ...
        if (string.IsNullOrEmpty(varName))
        {
            ...
            aiFeedback.RequestWrong(
                ...
                "east",
                "east_variable_empty",
                "اكتب اسمًا للصدفة قبل حفظ المتغير."
            );
            return; 
        }
        ...
        if (char.IsDigit(varName[0]))
        {
            ...
            aiFeedback.RequestWrong(
                this,
                "east",
                "east_variable_starts_digit:" + varName,
                "اسم المتغير لا يبدأ برقم؛ ابدأ بحرف."
            );
            return; 
        }
        if (varName.Contains(" "))
        {
            ...
            aiFeedback.RequestWrong(
                this,
                "east",
                "east_variable_has_space:" + varName,
                "اسم المتغير لا يحتوي مسافات؛ اجعله كلمة واحدة."
            );
            return; 
        }
        ...
        if (savedVariables.ContainsKey(varName))
        {
            ...
            aiFeedback.RequestWrong(
                this,
                "east",
                "east_variable_duplicate:" + varName,
                "هذا الاسم مستخدم؛ اختر اسمًا جديدًا للصدفة."
            );
            return; 
        }
        ...
        else
        {
            ...
            aiFeedback.RequestWrong(
                ...
                "east",
                "east_variable_limit",
                "عدد المتغيرات اكتمل؛ انتقل لخطوة الاسترجاع."
            );
        }
    }
    ...
    public void OnSubmit()
    {
        ...
        if (placedBlocks.Count == 0)
        {
            ...
            aiFeedback.RequestWrong(
                ...
                "east",
                "east_submit_empty",
                "ضع بلوك استرجاع المتغير قبل الإتمام."
            );
            return;
        }
        ...
        foreach (var block in placedBlocks)
        {
            ...
            if (block.GetSelectedShellID() < 0)
            {
                aiFeedback.RequestWrong(
                    this,
                    "east",
                    "east_submit_unselected",
                    "اختر اسم متغير داخل بلوك الاسترجاع."
                );
                return;
            }
